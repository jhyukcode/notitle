...
<div class="container card  my-5   p-3">
	...
	<form action="edit.do?bno=${dto.bno}" method="post"  id="writeForm"   onsubmit="return  form()">
		<div class="my-3">
		  ...
		  <input type="text"   name="bname" value="${dto.bname}" readonly  id="bname"   class="form-control" > 
		</div>																	
		<div class="my-3">
		  <label for="btitle" class="form-label"  >제목</label>
		  <input type="text"   name="btitle" value="${dto.btitle}"   id="btitle"   class="form-control" > 
		</div>	
		<div class="my-3">
