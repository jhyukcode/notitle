...
public class AnimalFarm {
	@Value("harry") private String name;
	...
	@Override
	public String toString() { return "AnimalFarm [name=" + name + ", ani=" + ani + "]"; }
	public AnimalFarm(String name, Animal ani) { super(); this.name = name; this.ani = ani; }
