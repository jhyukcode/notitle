...
<div class="container card  my-5 p-3 bg-light">
	...
	<form action="${pageContext.request.contextPath}/board/create" method="post"  id="writeForm"   onsubmit="return  form()">
		...
		<div class="my-3  text-end">
			<input type="submit"   value="게시"  class="btn btn-primary btn-block"    >  
			<input type="reset"    value="취소"  class="btn btn-outline-danger btn-block"    >  
			<a href="${pageContext.request.contextPath}/"   class="btn btn-outline-success btn-block"   >목록보기</a>
		</div>	
	</form> <!-- end form -->	
	<script>
	function form(){  
